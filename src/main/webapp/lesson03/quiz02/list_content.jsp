...
musicList.add(musicInfo);
%>
<div class="border border-success mt-4 d-flex p-3 mb-3">
 	<div class="mr-4">
...
<table class="table text-center">
	...
	<tbody>
		...
		<tr class="row">
			...
			<td class="col-3"><a href="/lesson03/quiz02/info_layout.jsp?id=<%=item.get("id")%>"><%=item.get("title")%></a></td>
			<td class="col-7"><%=item.get("album")%></td>
		</tr>
		<%
		}
		%>
